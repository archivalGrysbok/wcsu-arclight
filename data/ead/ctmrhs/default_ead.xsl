...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	two columns. -->
			...
			<!--If you do not want to include an image, delete the center
				...
				<center>
				<!-- <h4><xsl:value-of select="archdesc/did/repository"/></h4> -->
                  <img src="http://library.wcsu.edu/cao/images/cao_logo.jpg"></img>
				</center>
	
                 <!-- <div style="color: red; width:65%; padding: 5px; border: thin
                  solid black; margin: auto;">

                  <p>1) Right-mouse-click and choose &quot;view page source&quot; 2)Click the &quot;File&quot; menu and choose "Save as" 3) Name the file what you used as a &quot;filename&quot; in the template + .xml</p> 
