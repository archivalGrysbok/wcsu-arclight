...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/ead">
		<html>
			<head>
				...
				<link rel="stylesheet" type="text/css" href="http://archives.library.wcsu.edu/findingaids/ead_old.css"/>
				<link rel="stylesheet" type="text/css" href="http://archives.library.wcsu.edu/findingaids/findingaids.css" />
			<style type="text/css">
	...
	two columns. -->
			...
			<!--If you do not want to include an image, delete the center
				...
				<h2 class="repository"><xsl:value-of select="archdesc/did/repository/corpname"/></h2>
            <span class="masthead"><div class="showhim"><img src="http://archives.library.wcsu.edu/cao/images/ctvernhs.jpg" style="align: middle;" ></img>
			<!-- 
<div class="showme">	
			1) Right-mouse-click and choose &quot;view page source&quot; 2) Press CNTRL + &quot;a&quot; 3) Open a new email and press CTRL + &quot;v&quot; - that will paste the code into an email, send that email to stevensb@wcsu.edu</div> -->

<!-- Click the &quot;File&quot; menu and choose "Save as" 3) Name the file what you used as a &quot;filename&quot; in the template + .xml</div> -->
<!--
<div class="ok"><h2>This is a preview of what your finding aid will look like... </h2></div>
 -->
			</div></span>
...
<!-- Jamie and I were messing with this bit -->
...
a matching element with content in the finding aid.-->
	...
	<br> </br>
		<div style="text-align:left"><strong>
			<xsl:value-of select="filedesc/publicationstmt/publisher" /></strong></div>
			<xsl:for-each select="//publicationstmt/address/addressline"><div> <xsl:value-of select="."/> </div></xsl:for-each>
...
<!--Insert the address for the dsc stylesheet of your choice here.-->
	<!-- <xsl:include href="http://archives.library.wcsu.edu/cao/repositories/dsc4.xsl" /> -->
</xsl:stylesheet>
