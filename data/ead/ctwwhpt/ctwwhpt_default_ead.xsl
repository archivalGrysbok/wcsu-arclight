...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
	...
	<xsl:template match="/ead">
		<html>
			<head>
				...
				<link rel="stylesheet" type="text/css" href="http://archives.library.wcsu.edu/cao/css/ead_css_old.css"/>
				<link rel="stylesheet" type="text/css" href="http://archives.library.wcsu.edu/cao/css/findingaids.css" />
	...
	two columns. -->
            ...
            <span class="masthead"><div><img src="http://archives.library.wcsu.edu/cao/ctwwhpt/ctwwhpt.jpg" style="align: middle;" ></img></div>
			</span>
